...
from exiv.components.models.acestep.model_downloader import (
...
class InitServiceDownloadsMixin:
    ...
    def _sync_model_code_if_needed(config_path: str, checkpoint_path: Path) -> None:
        ...
        from exiv.components.models.acestep.model_downloader import _check_code_mismatch, _sync_model_code_files
        ...
        if mismatched:
            logger.warning(
                ...
                f"{mismatched}. Auto-syncing from exiv/components/models/acestep/core/..."
            )
