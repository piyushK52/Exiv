...
class InitServiceLoaderComponentsMixin:
    ...
    def _load_vae_model(self, *, checkpoint_dir: str, device: str, compile_model: bool) -> str:
        ...
        # Exiv integration: use Exiv's vae directory
        vae_checkpoint_path = "/root/Exiv/models/vae/vae"
    ...
    def _load_text_encoder_and_tokenizer(self, *, checkpoint_dir: str, device: str) -> str:
        ...
        # Exiv integration: use Exiv's text_encoders directory
        text_encoder_path = "/root/Exiv/models/text_encoders/Qwen3-Embedding-0.6B"
